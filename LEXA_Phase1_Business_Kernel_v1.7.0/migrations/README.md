...
5. `005_inventory_foundation.sql` — existing inventory implementation; not deployed as part of the v1.4.2 experience release
...
Migrations 008 and 009 are additive and have been applied to the LEXA development branch `lexa-live`. The LEXA production branch remains untouched.
