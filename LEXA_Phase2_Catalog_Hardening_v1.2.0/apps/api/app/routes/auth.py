...
def register(
    ...
    try:
        ...
        db.rollback()
        raise HTTPException(503, "Workspace service could not complete the database transaction") from exc
    except Exception as exc:
        db.rollback()
        raise HTTPException(500, "Workspace creation failed. Please try again.") from exc
